...
public class ComputeDerivedSymmetricKeySample
{
    ...
    private static final String ENROLLMENT_GROUP_SYMMETRIC_KEY = "1/OVv+5FzchFXFjbU+FEtBZZ8ZIsirUtXFbUYOI6n9P8vvkxKSiGSBEP0RZPa6UKGPA==";
    ...
    private static final String PROVISIONED_DEVICE_ID = "d-001";
